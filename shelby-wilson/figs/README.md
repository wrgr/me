...
Unmodified originals as downloaded, plus the re-encoded copies actually embedded
in `index.html` as data URIs. Both papers are Creative Commons Attribution 4.0,
which permits reproduction with credit.

| File | Source | Licence |
|---|---|---|
| `allogrooming-fig2.jpg` | Figure 2 of Wilson SN, Sindi SS, Brooks HZ, Hohn ME, Price CR, Radunskaya AE, Williams ND, Fefferman NH, "How Emergent Social Patterns in Allogrooming Combat Parasitic Infections", *Frontiers in Ecology and Evolution* 8:54 (2020). [doi:10.3389/fevo.2020.00054](https://doi.org/10.3389/fevo.2020.00054) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
...
Checked per paper, not assumed from "open access":

- ***CPT: Pharmacometrics & Systems Pharmacology*** 2015 — CC BY-**NC-ND**. The
  no-derivatives term makes resizing for the web legally awkward, so its figures
  are described but not shown.
